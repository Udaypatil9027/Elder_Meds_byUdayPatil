...
<div class="form-container">
    <h3>Add Donor</h3>
    <form id="donorForm" action="submitdonor" method="post" onsubmit="return validateForm()">
        <label>Enter Donor Name:</label>
        <input type="text" name="dname" required>

        <label>Donor Contact:</label>
        <input type="text" name="dcontact" id="dcontact" maxlength="10" title="Enter 10-digit mobile number" required>
        <div class="error-message" id="contactError"></div>

        <label>Donor Email:</label>
        <input type="text" name="demail" id="demail" title="Enter valid email like user@example.com" required>
...
<script>
    const emailField = document.getElementById("demail");
    const contactField = document.getElementById("dcontact");
    ...
    function validateForm() {
        ...
        if (contactField.classList.contains("invalid")) {
            contactField.focus();
            return false;
        }
